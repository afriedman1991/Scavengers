...
public class Wall : MonoBehaviour
{
    ...
    public Sprite dmgSprite;//Alternate sprite to display after Wall has been attacked by player. dmgSprite
    public int hp = 4;//hit points for the wall. hp starting at 4
