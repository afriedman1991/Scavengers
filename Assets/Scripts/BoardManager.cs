...
public class BoardManager : MonoBehaviour
{
    ...
    public GameObject[] playerTile;                                       //Prefab to spaw player character.
    ...
    {
        // Declare an integer randomIndex, set its value to a random number between 0 and the count of items in our List gridPositions.
        ...
        public void SetupScene(int level)
    {
        ...
        //Instantiate the player character at a random position.
        LayoutObjectAtRandom(playerTile, 1, 1);
